        ...
        <div className="flex flex-col items-center space-y-4 py-8">
          <div className="flex justify-between items-center w-full">
            ...
            <div className = "items-center space-x-4">
              <h2 className="text-5xl text-center font-bold">{carouselData[currentIndex].title}</h2>
              <p className="text-gray-500 py-6">{carouselData[currentIndex].description}</p>
            </div>
            <img
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 grid grid-cols-1 md:grid-cols-2 gap-8 py-8">
        <section>
          ...
          <div className="space-y-4">
            <Card className="w-full">
              <CardHeader>
                <CardTitle>Título de um artigo</CardTitle>
              </CardHeader>
              <CardContent>
        ...
        <section>
          ...
          <div className="space-y-4">
            ...
            <Link className="block mt-4 text-indigo-600 hover:text-indigo-500" href="#">
              {`
                    Ler mais novidades >`}
            </Link>
          </div>
