...
export default function Tickets() {
    ...
    <main className="flex flex-col items-center h-screen py-12">
        ...
        <div className="mb-8 text-center">
            <h1 className="text-4xl font-bold text-gray-900 dark:text-gray-100">MyTickets</h1>
        </div>
        <div className="overflow-hidden rounded-lg shadow-lg">
            ...
            <div className="grid grid-cols-7 gap-4 bg-gray-200 dark:bg-gray-800">
                ...
                {ticketInfo.map((ticket, index) => (
                    ...
                    <div key={ticket.id} className={`grid grid-cols-7 gap-4 ${index % 2 === 0 ? 'bg-gray-100 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600' : 'bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-600'}`}>
