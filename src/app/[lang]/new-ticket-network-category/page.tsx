      ...
      <main className="flex-1">
        ...
        <div className="container flex-1 max-w-screen-2xl max-w-7-xl mx-auto py-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <Link href={`/${lang}/new-ticket-network-details`}>
              <CardWithIcon
                title="Request Physical Network Access"
                description="Request for physical access to the institution's network for a space."
                icon={<Plus size={48} />}
              />
            </Link>
            <CardWithIcon
              title="Report Network Problem"
              description="Report a network problem at the institution."
